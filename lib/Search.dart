  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Search for store or item ',style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.w300),),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    SizedBox(height: 20,),
                                    Text(types[index]['title'],style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17),),
                                    Text(types[index]['describtion']),
                                    SizedBox(height: 20,),
                                    Text('${types[index]['stores']} stors',style: TextStyle(color: Color(0xFF1fad90)),),
                                  ],
                                )
                              ],
                            ),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Image.asset('images/delivryaMan.jpg',width: 100,),
                  Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Many desktop publishing ',style: TextStyle(color: Colors.white,fontSize: 10),),
                      Text('editors now use Lorem Ipsum as their',style: TextStyle(color: Colors.white,fontSize: 10),),
                      Text('for lorem ipsum will uncover many web infancy.',style: TextStyle(color: Colors.white,fontSize: 10),),
                    ],
                  ),
                  SizedBox(width: 40,),
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(describtion),
              SizedBox(height: 20,),
              Text('$no_stros stors',style: TextStyle(color: Color(0xFF1fad90)),),
            ],
          )
        ],
      ),
